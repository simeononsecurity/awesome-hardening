...
- [Harden Windows Security | A New Threat to Malware](https://github.com/HotCakeX/Harden-Windows-Security) - Harden Windows Safely, Securely, Only With Official Microsoft Methods
